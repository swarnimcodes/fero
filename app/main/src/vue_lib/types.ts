import { State } from '@swarnimcodes/fero-lib/bindings/State';
import { DeviceType } from '@swarnimcodes/fero-lib/bindings/DeviceType';
import { TransferType } from '@swarnimcodes/fero-lib/bindings/TransferType';
